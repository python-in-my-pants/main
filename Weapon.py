...
class Maschinenpistole(Weapon):
    def __init__(self, class_id=1, name="MP", cost=2, weight=1.9, acc=2, dmg=17, mag=20, spt=6):
        super().__init__(class_id, name,  cost, weight, acc, dmg, mag, spt)
...
class Maschinengewehr(Weapon):
    def __init__(self, class_id=4, name="MG", cost=3, weight=10.5, acc=1.5, dmg=20, mag=100, spt=10):
        super().__init__(class_id, name, cost, weight, acc, dmg, mag, spt)
...
class Raketenwerfer(Weapon):
    def __init__(self, class_id=6, name="RL", cost=5, weight=8, acc=1.7, dmg=100, mag=1, spt=1):
        super().__init__(class_id, name, cost, weight, acc, dmg, mag, spt)
# </editor-fold>
