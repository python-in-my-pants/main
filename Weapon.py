...
class Pistole(Weapon):
    def __init__(self, class_id=0, name="Pistole", cost=1, weight=42, acc=2.5, dmg=18, mag=10, spt=3):
        super().__init__(class_id, name, cost, weight, acc, dmg, mag, spt)


class Maschinenpistole(Weapon):
    def __init__(self, class_id=1, name="Maschinenpistole", cost=2, weight=60, acc=1.7, dmg=17, mag=20, spt=6):
        super().__init__(class_id, name,  cost, weight, acc, dmg, mag, spt)


class Sturmgewehr(Weapon):
    def __init__(self, class_id=2, name="Sturmgewehr", cost=3, weight=80, acc=2.7, dmg=22, mag=30, spt=5):
        super().__init__(class_id, name,  cost, weight, acc, dmg, mag, spt)
...
class Maschinengewehr(Weapon):
    def __init__(self, class_id=4, name="Maschinengewehr", cost=3, weight=120, acc=1.5, dmg=20, mag=100, spt=10):
        super().__init__(class_id, name, cost, weight, acc, dmg, mag, spt)
...
class Raketenwerfer(Weapon):
    def __init__(self, class_id=6, name="Raketenwerfer", cost=5, weight=150, acc=2, dmg=100, mag=1, spt=1):
        super().__init__(class_id, name, cost, weight, acc, dmg, mag, spt)
